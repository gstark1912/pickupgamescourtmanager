...
gulp.task('inject', function () {
  return gulp.src('Index.cshtml', {cwd: paths.index})
    .pipe(plugins.inject(
...
// Inject libraries via Bower in between of blocks "bower:xx" in Index.cshtml
...
// Compress into a single file the ones in between of blocks "build:xx" in Index.cshtml
